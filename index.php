				...
				<div id ="bodyContainer">
					<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center" id="bg">
					  <div class="col-md-5 p-lg-5 mx-auto my-5">
						...
						<p class="lead font-weight-normal" style="color:white;">Robinson University is now accepting enrollees for SY 2020-2021, starting from January 1 - February 28, 2021. </p>
